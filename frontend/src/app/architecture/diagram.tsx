  ...
  return (
    <div style={{
      ...
      <svg viewBox="0 0 800 380" style={{ width: "100%", height: "auto", maxWidth: 800 }} xmlns="http://www.w3.org/2000/svg" fontFamily="var(--font-inter), system-ui, sans-serif">
        ...
        <text x="28" y="28" fontSize="12" fontWeight="700" fill="var(--text-muted)" letterSpacing="0.08em">
          RAG Pipeline
        </text>
        ...
        <g>
          ...
          <text x={295} y={66} fontSize="14" fontWeight="700" fill={accent2} textAnchor="middle" dominantBaseline="middle">Semantic Search</text>
          <text x={295} y={83} fontSize="12" fill={accent2} textAnchor="middle" dominantBaseline="middle" opacity="0.7">pgvector (cosine sim)</text>
        </g>
        <g>
          ...
          <text x={295} y={136} fontSize="14" fontWeight="700" fill={accent3} textAnchor="middle" dominantBaseline="middle">Keyword Search</text>
          <text x={295} y={153} fontSize="12" fill={accent3} textAnchor="middle" dominantBaseline="middle" opacity="0.7">pg_trgm (fuzzy match)</text>
        </g>
        ...
        <g>
          ...
          <text x={500} y={91} fontSize="14" fontWeight="700" fill={accent1} textAnchor="middle" dominantBaseline="middle">Merge &amp; Rerank</text>
          <text x={500} y={108} fontSize="12" fill={accent1} textAnchor="middle" dominantBaseline="middle" opacity="0.7">Cross-encoder</text>
        </g>
        ...
        <g>
          ...
          <text x={690} y={91} fontSize="14" fontWeight="700" fill={accent2} textAnchor="middle" dominantBaseline="middle">LLM Context</text>
          <text x={690} y={108} fontSize="12" fill={accent2} textAnchor="middle" dominantBaseline="middle" opacity="0.7">Injection</text>
        </g>
        ...
        <g>
          ...
          <text x={690} y={217} fontSize="14" fontWeight="700" fill={accent4} textAnchor="middle" dominantBaseline="middle">Response</text>
        </g>
        ...
        <g>
          ...
          <text x={110} y={337} fontSize="14" fontWeight="700" fill={accent3} textAnchor="middle" dominantBaseline="middle">pgvector Index</text>
        </g>

        {/* Note */}
        <rect x={40} y={370} width={720} height={38} rx="8" fill="var(--bg)" stroke="var(--glass-border)" strokeWidth="1" strokeDasharray="4 4" />
        <text x="400" y="394" fontSize="12" fontWeight="500" fill="var(--text-muted)" textAnchor="middle" dominantBaseline="middle">
