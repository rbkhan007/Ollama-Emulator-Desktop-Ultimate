...
export default function ArchitecturePage() {
  return (
    <main style={{ maxWidth: 960, margin: "0 auto", padding: "40px 24px" }}>
      <h1 style={{ fontSize: "2.2rem", fontWeight: 800, marginBottom: 8, letterSpacing: "-0.02em" }}>Technical Deep Dive</h1>
      ...
      <section style={{ marginBottom: 48 }}>
        <h2 style={{ fontSize: "1.4rem", fontWeight: 700, marginBottom: 6 }}>Request Lifecycle</h2>
      ...
      <section>
        <h2 style={{ fontSize: "1.4rem", fontWeight: 700, marginBottom: 6 }}>RAG Pipeline</h2>
        <p style={{ color: "var(--text-muted)", fontSize: 14, marginBottom: 20, lineHeight: 1.6 }}>
